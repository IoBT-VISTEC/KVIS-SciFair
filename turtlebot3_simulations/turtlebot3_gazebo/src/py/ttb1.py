...
class Turtlebot3_drive():
    def __init__(self):
        ...
        self.cmd_vel_pub = rospy.Publisher("/ttb_black/cmd_vel", Twist, queue_size=10) ##
        self.score_pub = rospy.Publisher("/score", Score, queue_size=10) ##
        self.odom_sub = rospy.Subscriber("/ttb_black/odom", Odometry, self.odomMsgCallback) ##
        self.scan_low_sub = rospy.Subscriber("/ttb_black/scan", LaserScan, self.objectScanMsgCallback) ##
        self.scan_high_sub = rospy.Subscriber("/ttb_black/scanhigh", LaserScan, self.wallScanMsgCallback) ##
